      ...
      <div className="footerBottom">
        <div className="footerBottomCopyright">
          <p className="footerBottomText">
            Copyright &copy; RICPESHOP. All Rights Reserved.
          </p>
          <p className="footerBottomText">
            Design: <Link to="/">RicpeWebCode</Link>
          </p>
          <p className="footerBottomText">
            Distributed By: <Link to="/">Miljan Peric</Link>
          </p>
          <div className="footerBottomSocials flex justify-center items-center">
            <Link to="/">
              <FaFacebookF />
            </Link>
            <Link to="/">
